...
public static class ActionCatalog
{
    ...
    private static readonly Dictionary<string, IReadOnlyList<ActionTagOption>> TagOptionsCache = new(StringComparer.OrdinalIgnoreCase);
    private static readonly Dictionary<string, IReadOnlyList<ActionOption>> AllCache = new(StringComparer.OrdinalIgnoreCase);
    ...
    public static IReadOnlyList<ActionTagOption> TagOptions => GetLocalizedList(
        TagOptionsCache,
        static () =>
        [
    ...
    public static IReadOnlyList<ActionOption> All => GetLocalizedList(
        AllCache,
        static () =>
        [
