...
public static class StandardKeyCatalog
{
    ...
    [
        new(StandardKeyGroup.Navigation, "Navigation"),
        new(StandardKeyGroup.Editing, "Editing"),
        new(StandardKeyGroup.Modifiers, "Modifiers"),
        new(StandardKeyGroup.Function, "Function"),
        new(StandardKeyGroup.Letters, "Letters"),
        new(StandardKeyGroup.Numbers, "Numbers"),
        new(StandardKeyGroup.Symbols, "Symbols"),
        new(StandardKeyGroup.Numpad, "Numpad"),
        new(StandardKeyGroup.Browser, "Browser")
    ];

    public static IReadOnlyList<StandardKeyOption> All { get; } =
    [
        new("Escape", "Esc", 0x1B, StandardKeyGroup.Navigation),
        new("Left", "Left Arrow", 0x25, StandardKeyGroup.Navigation),
        new("Up", "Up Arrow", 0x26, StandardKeyGroup.Navigation),
        new("Right", "Right Arrow", 0x27, StandardKeyGroup.Navigation),
        new("Down", "Down Arrow", 0x28, StandardKeyGroup.Navigation),
        new("Apps", "Menu", 0x5D, StandardKeyGroup.Navigation),
        new("ScrollLock", "Scroll Lock", 0x91, StandardKeyGroup.Navigation),
        new("Pause", "Pause", 0x13, StandardKeyGroup.Navigation),

        new("Tab", "Tab", 0x09, StandardKeyGroup.Editing),
        new("Enter", "Enter", 0x0D, StandardKeyGroup.Editing),
        new("Space", "Space", 0x20, StandardKeyGroup.Editing),
        new("Backspace", "Backspace", 0x08, StandardKeyGroup.Editing),
        new("Delete", "Delete", 0x2E, StandardKeyGroup.Editing),
        new("Insert", "Insert", 0x2D, StandardKeyGroup.Editing),
        ...
        new("CapsLock", "Caps Lock", 0x14, StandardKeyGroup.Editing),
        new("NumLock", "Num Lock", 0x90, StandardKeyGroup.Editing),
        ...
        new("LeftWindows", "Left Windows", 0x5B, StandardKeyGroup.Modifiers),
        new("RightWindows", "Right Windows", 0x5C, StandardKeyGroup.Modifiers),
        ...
        new("NumPad0", "NumPad 0", 0x60, StandardKeyGroup.Numpad),
        new("NumPad1", "NumPad 1", 0x61, StandardKeyGroup.Numpad),
        new("NumPad2", "NumPad 2", 0x62, StandardKeyGroup.Numpad),
        new("NumPad3", "NumPad 3", 0x63, StandardKeyGroup.Numpad),
        new("NumPad4", "NumPad 4", 0x64, StandardKeyGroup.Numpad),
        new("NumPad5", "NumPad 5", 0x65, StandardKeyGroup.Numpad),
        new("NumPad6", "NumPad 6", 0x66, StandardKeyGroup.Numpad),
        new("NumPad7", "NumPad 7", 0x67, StandardKeyGroup.Numpad),
        new("NumPad8", "NumPad 8", 0x68, StandardKeyGroup.Numpad),
        new("NumPad9", "NumPad 9", 0x69, StandardKeyGroup.Numpad),
        new("Multiply", "NumPad *", 0x6A, StandardKeyGroup.Numpad),
        new("Add", "NumPad +", 0x6B, StandardKeyGroup.Numpad),
        new("Subtract", "NumPad -", 0x6D, StandardKeyGroup.Numpad),
        new("Decimal", "NumPad .", 0x6E, StandardKeyGroup.Numpad),
        new("Divide", "NumPad /", 0x6F, StandardKeyGroup.Numpad),

        new("BrowserBack", "Back", 0xA6, StandardKeyGroup.Browser),
        new("BrowserForward", "Forward", 0xA7, StandardKeyGroup.Browser),
        new("BrowserRefresh", "Refresh", 0xA8, StandardKeyGroup.Browser),
        new("BrowserStop", "Stop", 0xA9, StandardKeyGroup.Browser),
        new("BrowserSearch", "Search", 0xAA, StandardKeyGroup.Browser),
        new("BrowserFavorites", "Favorites", 0xAB, StandardKeyGroup.Browser),
        new("BrowserHome", "Browser Home", 0xAC, StandardKeyGroup.Browser)
    ];
    ...
    {
        return GetOption(key)?.Label ?? "Choose standard key";
    }
